...
namespace Ancient_Harvests
{
    ...
    public class Ancient_HarvestsPlugin : BaseUnityPlugin
    {
        internal const string ModName = "Ancient_Harvests";
        ...
        public static readonly ManualLogSource Ancient_HarvestsLogger = BepInEx.Logging.Logger.CreateLogSource(ModName);
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                Ancient_HarvestsLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                Ancient_HarvestsLogger.LogError($"There was an issue loading your {ConfigFileName}");
                Ancient_HarvestsLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
